...
<footer className="bg-gray-900 text-white bg-neutral-primary">
    ...
    <div className="px-4 py-6 bg-neutral-secondary-soft md:flex md:items-center md:justify-between">
        <span className="text-sm text-body sm:text-center">© 2026 <a href="https://flowbite.com/">Rajat™</a>. All Rights Reserved.
        </span>
